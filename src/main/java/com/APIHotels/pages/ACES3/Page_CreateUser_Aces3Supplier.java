...
public class Page_CreateUser_Aces3Supplier extends BasePage{
	...
	public Page_CreateUser_Aces3Supplier(EventFiringWebDriver driver){
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}
	
	public void createUser(String firstName, String lastName, String emailId, String roles,
			String createByIndicator, String tempUserName, String tempPassword) throws Exception{
